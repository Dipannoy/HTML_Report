<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Lab1.aspx.cs" Inherits="HTML_Report.Lab1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        ...
        function PrintReport()
        {
            ...
            middleContent += "<div class='col-sm-10'>";
            middleContent += "<table id='customers'><thead>";
            middleContent += "<tr><th>SL No</th>";
            middleContent += "<th> Roll </th>";
            middleContent += "<th> Name</th>";
            middleContent += "<th> Grade</th>";
            middleContent += "<th> Due</th>";
            middleContent += "<th> Discount</th>";
            middleContent += "<th> Final Due</th></tr></thead><tbody>";

            for(var i = 0; i<imaginary_dataset_2.studentlist.length;i++)
            {
                middleContent += "<tr><td>" + (i+1)+"</td>";
                middleContent += "<td>"+imaginary_dataset_2.studentlist[i].roll+"</td>";
                middleContent += "<td>"+imaginary_dataset_2.studentlist[i].name+"</td>";
                middleContent += "<td>"+imaginary_dataset_2.studentlist[i].grade+"</td>";
                middleContent += "<td>"+imaginary_dataset_2.studentBill[i].due+"</td>";

                middleContent += "<td>"+imaginary_dataset_2.studentDiscounts[i].discount+"</td>";

                middleContent += "<td>"+imaginary_dataset_2.studentBill[i].due*(1 - (imaginary_dataset_2.studentDiscounts[i].discount)/100)+"</td>";
                middleContent += "</tr>";
            }
            middleContent += "</tbody></table></div>";
            middleContent += "<div class='col-sm-1'></div></div>";
            ...
            mywindow.document.write(middleContent);
